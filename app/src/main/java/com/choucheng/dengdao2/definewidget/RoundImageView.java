...
public class RoundImageView extends ImageView {
	...
	private int defaultColor = -11111110;
	...
	private void setCustomAttributes(AttributeSet attrs) {
		...
		Log.d(tag, "mBorderThickness:" + mBorderThickness);
		Log.d(tag, "mBorderOutsideColor:" + mBorderOutsideColor);
		Log.d(tag, "mBorderInsideColor:" + mBorderInsideColor);
