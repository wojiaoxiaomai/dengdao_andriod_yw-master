...
public class RefreshListView extends ListView implements OnScrollListener, OnClickListener {
	...
	public void onScroll(AbsListView arg0, int firstVisiableItem, int visibleItemCount, int totalItemCount) {
		...
		Logger.i("Refresh", "lastItem:" + lastItem);

	}

	public void onScrollStateChanged(AbsListView arg0, int arg1) {
		Logger.i("Refresh", "onScrollStateChanged");
		if (lastItem == getAdapter().getCount()
				&& arg1 == OnScrollListener.SCROLL_STATE_IDLE
				&&mLoadMoreState!= ILoadMoreViewState.LMVS_OVER
				) {
			Logger.e("Refresh", "load more");
	...
	private void updateLoadMoreViewState(int state)
	{
		switch(state)
		{
			case ILoadMoreViewState.LMVS_NORMAL:
				...
				mLoadMoreTextView.setText(R.string.load_more_data);
				mFootView.setVisibility(View.GONE);
				break;
			...
			case ILoadMoreViewState.LMVS_OVER:
				mLoadingView.setVisibility(View.GONE);
				mLoadMoreTextView.setVisibility(View.VISIBLE);
				mLoadMoreTextView.setText(R.string.no_more_data);
				mFootView.setVisibility(View.VISIBLE);
				break;
				default:
					break;
