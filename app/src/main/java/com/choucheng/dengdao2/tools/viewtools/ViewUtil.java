...
import com.choucheng.dengdao2.tools.TextUtils;
...
public class ViewUtil {
    ...
    public static class OnTouchListener_view_bg_color implements View.OnTouchListener {
        int color = DATE_NULL;
        int color_down = DATE_NULL;

        public OnTouchListener_view_bg_color(int color_down) {
    ...
    public static class OnTouchListener_softInput_hide implements View.OnTouchListener {
        ...
        @Override
        public boolean onTouch(View v, MotionEvent event) {
//            Log.d(TAG,"OnTouchListener_softInput_hide.onTouch v.getId():"+v.getId());
...
//            imm.toggleSoftInput(0, InputMethodManager.SHOW_IMPLICIT);
    ...
    private static class SetTextView_textNewline implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            float textW = TextUtils.getTextViewWidth(tv);
            if ((textW / viewW) > 0) {
...
//                    mainApplication.logUtil.d("(oldStrng.length()-1-newlineIndex):"+(oldStrng.length()-1-newlineIndex));
//                    mainApplication.logUtil.d("oldStrng.length():"+oldStrng.length());
//                    mainApplication.logUtil.d("newlineIndex:"+newlineIndex);
